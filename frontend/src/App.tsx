...
function StatusBadge({ status }: { status?: RenameItem['status'] }) {
  if (status === 'create') return <span className="status-badge ready"><Icon name="folder" size={13} /> Create folder</span>
...
export default function App() {
  ...
  const undoNeedsAttention = renamer.undoNeedsAttention
